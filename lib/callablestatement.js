...
CallableStatement.prototype.getString = function(arg1, callback) {
  if (typeof arg1 === 'number' || typeof arg1 === 'string') {
    this._cs.getString(arg1, function(err, result) {
      if (err) {
        return callback(err);
      } else {
        return callback(null, result);
...
CallableStatement.prototype.registerOutParameter = function() {
  var args = Array.prototype.slice.call(arguments);
console.log('registerOutParameter: ', args);
  var callback = args.pop();
console.log('registerOutParameter: ', (typeof args[0] == 'number'));
console.log('registerOutParameter: ', (typeof args[1] == 'number'));
